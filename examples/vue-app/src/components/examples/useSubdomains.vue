<template>
  <UsageExample :name="fileName">
    ...
    <div>Subdomains: {{ isLoading ? 'Loading...' : result }}</div>
  </UsageExample>
</template>
...
import { useSubdomains } from '@bonfida/sns-vue';
...
const { result, isLoading } = useSubdomains(connection!, debouncedFormValue);
</script>
