...
cluster_constants! {
    ...
    mainnet {
        ...
        pub const PYTH_PRICE_PRODUCT_ACCOUNTS: &[(Pubkey, Pubkey, Pubkey)] = &[
            (
                USDC_MINT,
    ...
    devnet {
        ...
        pub const MSOL_MINT: Pubkey = Pubkey::default();
        pub const BONK_MINT: Pubkey = Pubkey::default();
        pub const BAT_MINT: Pubkey = Pubkey::default();
